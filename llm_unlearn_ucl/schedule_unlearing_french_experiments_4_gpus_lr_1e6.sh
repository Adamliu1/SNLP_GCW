...
# config file
LAUNCHER="accelerate launch --config_file /SAN/intelsys/llm/sduchnie/SNLP_GCW/llm_unlearn_ucl/deepspeed_4gpu_offload.yaml"
...
EXPERIMENT_NAME="llama3_sequential_french_$LR""_BS$BATCH_SIZE""_EPOCHS$epochs"
